...
const seoData = {
  ...
  '/thank-you': {
    ...
    description: 'Thank you for reaching out to Vertical Worx. We will contact you shortly regarding your inquiry.',
    keywords: 'thank you, helicopter services contact confirmation',
    ogType: 'website'
  }
};
